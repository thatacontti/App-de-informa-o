...
// Strip aspas (`"..."` / `'...'`) e CR/LF que o Node `--env-file` deixa passar
// no Windows. Sem isso, headers HTTP saem com aspas literais e quebram a auth.
const env = (k, def = '') => {
  let v = process.env[k];
...
const EXCIA_BASE = env('EXCIA_BASE', 'http://192.168.1.6:211');
const EXCIA_TOKEN = env('EXCIA_TOKEN', '00EE2138AB67015BED838EC09E55C6A9');
